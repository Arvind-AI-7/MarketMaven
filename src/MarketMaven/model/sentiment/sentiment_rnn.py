...
class Sentiment_RNN():
    ...
    def train_sent_rnn(self):
        ...
        model.save("src/MarketMaven/pt_h5_pkl/sent_rnn.h5")
    ...
    def test_sent_rnn(self):
        ...
        figure.write_image("src/MarketMaven/screenshots/sentiment_rnn.png")
